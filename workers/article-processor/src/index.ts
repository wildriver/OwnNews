 ...
 *  30日→7日に短縮（2026-08-02）: 収集が毎時化して約4,500件/日×30日=13万行・
 *  埋め込みだけで550MBとなりSupabase無料枠(500MB)を445%超過したため。
 *  パックは直近72時間しか使わず、研究用全データはR2の日次アーカイブにあるので
 *  DBは7日で十分（影響は管理ダッシュボードの母集団チャートの窓が7日分になる程度）。 */
